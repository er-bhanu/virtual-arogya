    ...
    <div class="home-content" id="list-dash">
      <div class="overview-boxes">
        <div class="box">
          ...
          <img src="dr.jpg" alt="Example Image" width="300" height="200">
        ...
        <div class="box">
          <div class="right-side">
          <img src="patient2.avif" alt="Example Image" width="300" height="200">
           <h4>Patient List</h4>
            <p class="cl-effect-1">
        ...
        <div class="box">
          <div class="right-side">
          <img src="appointment.jpg" alt="Example Image" width="300" height="200">
      ...
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
          <img src="Prescription.png" alt="Example Image" width="300" height="200">
