...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost", "bhanupra_singh", "Bhanu@2001", "bhanupra_hospitalms");
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> Virtual आरोग</a>
